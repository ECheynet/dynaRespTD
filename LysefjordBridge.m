function [Bridge] = LysefjordBridge(Nyy,varargin)
...
%         - y : discretisation of bridge axis into normalized coordinates
...
Bridge.y = linspace(0,1,Bridge.Nyy); % discretisation of bridge axis into normalized coordinates

% if T~=293,
%     Bridge.E = 210000e6.*(293./T).^2; % young modulus steel (Pa) *
%     Bridge.Ec = 180000e6.*(293./T).^2; % young modulus steel (Pa) *
% else
